...
import com.wutong.pictureinformation.service.DownloadService;
...
//                Toast.makeText(mContext,"您点击了图片",Toast.LENGTH_SHORT).show();
...
//                Log.d("你选择的图片地址",picture.getUrl());
                mContext.startService(intent);//启动服务
                Toast.makeText(mContext,"下载完成",Toast.LENGTH_SHORT).show();
                popupWindow.dismiss();//关闭弹窗
//                mContext.stopService(intent);//关闭服务
            }
        });
        ...
        btnCollectPic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pictureCollect.setUrl(picture.getUrl());
                Log.d("PictureRecyclerViewAdapter", picture.getUrl());
                PictureCollectController pictureCollectController=new PictureCollectController(mContext);
                boolean flag=pictureCollectController.collectPicture(pictureCollect);
                if (flag){
